...
namespace Class_HART
{
    public partial class Conect
    {
        ...
        static public string[] MTM701_Cods_Type = new string[]{ // Коды единиц типа уставки
        "Отключено","Нижняя","Верхняя","Оконная внутр.","Оконная внеш."
        };

        static public string[] MTM701_Cods_Priv = new string[]{ // Коды единиц привязки уставки
        "Давление","Температура","Уровень","Объём","Масса"
        };
        /// <summary>
